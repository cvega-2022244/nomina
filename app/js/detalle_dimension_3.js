        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.includes('Query Falló')) {
                    ...
                    console.log('No hay sub divisiones registradas');
                    ...
                    try {
                        ...
                        console.error('Error al procesar sub divisiones:', error);
                        resolve(); // Resolver aunque haya error
                    } finally {
                        resolve(res);
                    }
            ...
            error: function (xhr, status, error) {
                console.error('Error AJAX al cargar sub divisiones:', error);
                Swal.fire({
                    icon: 'error',
                    title: 'Error de Conexión',
                    text: 'No se pudieron cargar las sub divisiones. Por favor, intente de nuevo.',
                    allowOutsideClick: false,
...
function listado_dimension_4_combobox() {
    return new Promise((resolve, reject) => {
        $.ajax({
            ...
            success: function (res) {
                console.log('Sub divisiones combobox:', res);
                if (res.includes('Query Falló')) {
                    Swal.fire({
                        icon: 'error',
                    ...
                    console.log('No hay sub divisiones disponibles en combobox');
                    ...
                    try {
                        ...
                        console.error('Error al procesar combobox de sub divisiones:', error);
                        resolve(); // Resolver aunque haya error
                    }
                }
            },
            error: function (xhr, status, error) {
                console.error('Error AJAX al cargar combobox de sub divisiones:', error);
                resolve(); // Resolver para continuar con el flujo
            }
        });
    }).then(() => {
...
function editar_dimension_3() {
    ...
    if (nombre_dimension.value != "") {
        ...
        Swal.fire({
            title: 'Campos Vacíos',
            text: 'Por favor, ingrese el nombre de la división.',
            icon: 'warning',
            allowOutsideClick: false,
            showConfirmButton: true,
            showCancelButton: false,
...
function editar_dimension_4() {
    ...
    if (nombre_dimension[0].innerText != "Sub División...") {
        ...
        $.ajax({
            ...
            success: function (res) {
                console.log('Respuesta editar sub división:', res);
                let respuesta = String(res).trim();
            ...
            error: function (xhr, status, error) {
                console.error('Error AJAX al editar sub división:', error);
                Swal.fire({
                    icon: 'error',
                    title: 'Error de Conexión',
                    text: 'No se pudo conectar con el servidor. Por favor, intente de nuevo.',
...
function guardar_dimension_4() {
    ...
    if (nombre_dimension[0].innerText != "Sub División...") {
        ...
        $.ajax({
            ...
            success: function (res) {
                console.log('Respuesta agregar sub división:', res);
                let respuesta = String(res).trim();
            ...
            error: function (xhr, status, error) {
                console.error('Error AJAX al agregar sub división:', error);
                Swal.fire({
                    icon: 'error',
                    title: 'Error de Conexión',
                    text: 'No se pudo conectar con el servidor. Por favor, intente de nuevo.',
...
function eliminar_dimension_4(id_dimension3_dimension4) {
    $.ajax({
        ...
        success: function (res) {
            console.log('Respuesta eliminar sub división:', res);
            let respuesta = String(res).trim();
            ...
            if (respuesta.includes('Successfully')) {
                ...
                Swal.fire({
                    ...
                    text: 'Ha ocurrido un error al eliminar la sub división',
                    icon: 'error',
                    showCancelButton: false,
                    allowOutsideClick: false,
                    showConfirmButton: true
        ...
        error: function (xhr, status, error) {
            console.error('Error AJAX al eliminar sub división:', error);
            Swal.fire({
                icon: 'error',
                title: 'Error de Conexión',
                text: 'No se pudo conectar con el servidor. Por favor, intente de nuevo.',
