...
function informacion_pago() {
    return new Promise((resolve) => {
        try {
            var id_empleado = sessionStorage.getItem('id_empleado_detalle')
            var bonos_confirmados = sessionStorage.getItem('bonos_confirmados');
            var fecha_actual = new Date();
            var nombre_mes = fecha_actual.toLocaleString("es-US", { month: "long" });
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    document.getElementById('concepto').value = `Pago nomina ${nombre_mes} ${anio_actual}`
