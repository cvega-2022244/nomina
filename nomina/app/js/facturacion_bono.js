...
$.ajax({
    ...
    data: {
        quest: 'bono_real',
        anio: sessionStorage.getItem("anio_bono")
    },
...
function excel_real() {
    var anio = sessionStorage.getItem("anio_bono")
    window.location.href = './php/facturacion_bono_real.php?anio=' + anio;
}
...
function excel_contable() {
    var anio = sessionStorage.getItem("anio_bono")
    window.location.href = './php/facturacion_bono_contable.php?anio=' + anio;
}
...
function excel_ajuste_rh() {
    var anio = sessionStorage.getItem("anio_bono")
    window.location.href = './php/facturacion_bono_ajuste_rh.php?anio=' + anio;
}
...
function excel_determinacion() {
    var anio = sessionStorage.getItem("anio_bono")
    window.location.href = './php/facturacion_bono_determinacion.php?anio=' + anio;
}
...
function excel_intercompany() {
    var anio = sessionStorage.getItem("anio_bono")
    window.location.href = './php/facturacion_bono_intercompany.php?anio=' + anio;
}