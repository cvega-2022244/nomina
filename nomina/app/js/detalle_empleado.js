...
var f2 = flatpickr(document.getElementById("fecha_inicio"));
var f3 = flatpickr(document.getElementById("fecha_baja"));
var f4 = flatpickr(document.getElementById("tiempo_temporal"));
//------------------------Variables Globales----------------------//
...
async function cargarEstados() {
  try {
    ...
    selectBox = new vanillaSelectBox("#estado", {
      active: false,
...
async function cargarEstadosCiviles() {
  try {
    ...
    selectBox = new vanillaSelectBox("#estado_civil", {
      active: false,
      keepInlineStyles: true,
      maxHeight: 678,
      minWidth: 200,
...
async function cargarGeneros() {
  try {
    ...
    selectBox = new vanillaSelectBox("#genero", {
      active: false,
      keepInlineStyles: true,
      maxHeight: 678,
      minWidth: 200,
...
async function cargarTiposPago() {
  try {
    ...
    selectBox = new vanillaSelectBox("#pago", {
      active: false,
      keepInlineStyles: true,
      maxHeight: 678,
      minWidth: 200,
...
async function cargarTiposCuenta() {
  try {
    ...
    selectBox = new vanillaSelectBox("#tipo_cuenta", {
      active: false,
      keepInlineStyles: true,
      maxHeight: 678,
      minWidth: 200,
...
async function cargarMonedas() {
  try {
    ...
    selectBox = new vanillaSelectBox("#moneda", {
      active: false,
      keepInlineStyles: true,
      maxHeight: 678,
      minWidth: 200,
...
async function cargarDepartamentos() {
  try {
    ...
    if (lista.includes('No hay datos')) {
      ...
      selectBox = new vanillaSelectBox("#departamento_laboral", {
        active: false,
        keepInlineStyles: true,
        maxHeight: 678,
        minWidth: 200,
...
async function cargarCentrosCosto() {
  try {
    ...
    if (lista.includes('No hay datos')) {
      ...
      selectBox = new vanillaSelectBox("#centro_de_costo", {
        active: false,
        keepInlineStyles: true,
        maxHeight: 678,
        minWidth: 200,
...
async function cargarCondiciones() {
  try {
    ...
    selectBox = new vanillaSelectBox("#condicion_laboral", {
      active: false,
      keepInlineStyles: true,
      maxHeight: 678,
      minWidth: 200,
...
async function cargarTiposLicencia() {
  try {
    ...
    selectBox = new vanillaSelectBox("#tipo_licencia", {
      active: false,
      keepInlineStyles: true,
      maxHeight: 678,
      minWidth: 200,
...
async function cargarClasesLicencia() {
  try {
    ...
    selectBox = new vanillaSelectBox("#clase_licencia", {
      active: false,
      keepInlineStyles: true,
      maxHeight: 678,
      minWidth: 200,
    ...
    try {
      $.ajax({
        ...
        success: function (resp) {
          ...
          combobox[5].innerHTML =
            estado_empleado.options[estado_empleado.selectedIndex].text;
          estado_civil.value = lista[0].estado_civil;
          combobox[6].innerHTML =
            estado_civil.options[estado_civil.selectedIndex].text;
          genero.value = lista[0].genero;
          combobox[7].innerHTML = genero.options[genero.selectedIndex].text;
          ...
          edad.value = lista[0].edad;
          tipo_licencia.value = lista[0].id_tipo_licencia;
          combobox[8].innerHTML =
            tipo_licencia.options[tipo_licencia.selectedIndex].text;
          clase_licencia.value = lista[0].id_clase_licencia;
          combobox[9].innerHTML =
            clase_licencia.options[clase_licencia.selectedIndex].text;
          ...
          if (lista[0].tipo_cuenta != null) {
            ...
            combobox[12].innerHTML =
              tipo_cuenta.options[tipo_cuenta.selectedIndex].text;
          }
          banco.value = lista[0].banco;
          combobox[10].innerHTML = banco.options[banco.selectedIndex].text;
          pago.value = lista[0].tipo_de_pago;
          combobox[11].innerHTML = pago.options[pago.selectedIndex].text;
          moneda.value = lista[0].moneda;
          combobox[13].innerHTML = moneda.options[moneda.selectedIndex].text;
          ...
          combobox[0].innerHTML =
            departamento_laboral.options[departamento_laboral.selectedIndex].text;
          ...
          combobox[1].innerHTML =
            centro_de_costo.options[centro_de_costo.selectedIndex].text;
          combobox[2].innerHTML =
            dimension_3.options[dimension_3.selectedIndex].text;
          combobox[3].innerHTML = lista[0].dimension_4 == null ? "Sub División..." :
            dimension_4.options[dimension_4.selectedIndex].text;
          combobox[4].innerHTML = lista[0].dimension_5 == null ? "Nivel 5..." :
            dimension_5.options[dimension_5.selectedIndex].text;
          ...
          combobox[14].innerHTML =
            condicion_laboral.options[condicion_laboral.selectedIndex].text;
          ...
          combobox[15].innerHTML =
            jornada.options[jornada.selectedIndex].text;
...
function limpiar_inputs_estudios() {
  ...
  selectBox = new vanillaSelectBox("#universidad_modal", {
    keepInlineStyles: true,
    maxHeight: 678,
    minWidth: 200,
    search: true,
...
function validar_porcentaje_intercompany() {
  ...
  empresas_intercompany.forEach((empresa) => {
    var input = document.getElementById("inp_porcentaje_" + empresa.id_empresa);
...
function validar_inputs_empleado() {
  ...
  if (
    ...
    id_permisos.value != "" &&
    id_permisos.value != "0" &&
    combobox[5].innerText != "Estado..." &&
    combobox[6].innerText != "Estado Civil..." &&
    combobox[7].innerText != "Género..." &&
    combobox[0].innerText != "Departamento..." &&
    combobox[1].innerText != "Área..." &&
    combobox[2].innerText != "División..." &&
    combobox[11].innerText != "Tipo de pago..." &&
    combobox[13].innerText != "Moneda..." &&
    combobox[14].innerText != "Condición..." &&
    combobox[15].innerText != "Jornada..."
  ) {
    return true;
  } else {
    return false;
    ...
    if (validar_fecha_baja()) {
      if (validar_inputs_planilla()) {
        if (validar_inputs_originario()) {
          if (validar_inputs_otros()) {
            ...
            Swal.fire({
              ...
              text: "Por favor asegurese de haber ingresado valores validos en el apartado de Otros",
            });
          }
        } else {
          Swal.fire({
        ...
        Swal.fire({
          ...
          text: "Por favor asegurese de haber ingresado valores validos en el apartado de Planilla",
        });
      }
    } else {
      Swal.fire({
    ...
    $.ajax({
      ...
      success: function (res) {
        if (res.includes("Query Falló")) {
          Swal.fire({
            icon: "error",
            title: "Error Al Ingrear IGSS Laboral ",
            text: "Por favor, comunicate con sistemas",
          });
          console.log(res);
        } else {
    ...
    $.ajax({
      ...
      success: function (res) {
        if (res.includes("Query Falló")) {
          Swal.fire({
            icon: "error",
            title: "Error Al Ingrear IGSS Patronal ",
            text: "Por favor, comunicate con sistemas",
          });
          console.log(res);
        } else {
