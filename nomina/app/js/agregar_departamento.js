...
function ingresar_departamento() {
    return new Promise((resolve) => {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.includes('Successfully')) {
                    ...
                    Swal.fire({
                        title: 'Error al Agregar Departamento :(',
                        html: 'A ocurrido un error al agregar el dimension 1, por favor, comunicate con sistemas',
                        icon: 'warning',
                        allowOutsideClick: false,
                        showConfirmButton: true,
                        showCancelButton: false
        ...
        if (centros_costo.length >= 1) {
            ...
            Swal.fire({
                title: 'Departamento Agregada',
                html: 'El dimension 1 se agrego de manera exitosa.',
                icon: 'success',
                allowOutsideClick: false,
                showConfirmButton: false,
                showCancelButton: false,
